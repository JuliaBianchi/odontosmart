<template>
  <section class=" h-screen pt-40 bg-white">
    ...
    <div class="pt-10 flex flex-col mb-8 md:mb-auto gap-3.5 flex-1 p-4 mt-16">
      <div
      ...
      >
        <div class="flex gap-4 items-start flex-col">
          ...
          ></span>
          <div>
            <h3 class="font-semibold text-xl">Gerenciar Anúncios</h3>
            <p class="mt-1 text-gray-500">
              Atualizar informações do consultório, serviços, fotos e preços.
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-4 items-start flex-col">
          ...
          ></span>
          <div>
            <h3 class="font-semibold text-xl">Monitorar Desempenho</h3>
            <p class="mt-1 text-gray-500">
              Acompanhar o número de visualizações, contatos e agendamentos do
              seu anúncio.
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-4 items-start flex-col">
          ...
          ></span>
          <div>
            <h3 class="font-semibold text-xl">Comunicar-se com Clientes</h3>
            <p class="mt-1 text-gray-500">
              Responder a mensagens e dúvidas de clientes potenciais através da
              plataforma.
            </p>
          </div>
        </div>
